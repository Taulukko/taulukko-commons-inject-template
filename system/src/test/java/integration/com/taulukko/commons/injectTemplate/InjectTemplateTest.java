...
public class InjectTemplateTest {
	...
	private static final String URL_BASE = "http://localhost:" + 8182 + "/";
	...
	public static void end() throws Exception {
		 ...
		 * 
		 * You have 30 seconds to test until goal package run (required use goal package
		 * maven to run this test) To increment this time, increment the sleepTime
		 * 
